...
public class Addition extends AppCompatActivity {
        ...
        new CountDownTimer(500000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (counter <= 30) {
                    ...
                    step2.setBackground(getResources().getDrawable(R.drawable.circle_btn_orange));
                    ...
                    step3.setBackground(getResources().getDrawable(R.drawable.circle_btn_orange));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
                    ...
                    step4.setBackground(getResources().getDrawable(R.drawable.circle_btn_orange));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
                    ...
                    step5.setBackground(getResources().getDrawable(R.drawable.circle_btn_orange));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
    ...
    void sendScore(int score) {
        ...
        Intent i = new Intent();
        i.putExtra("addition", score);
        ref.setScorePenjumlahan(getApplicationContext(), "addition", score);
        startActivity(new Intent(getApplicationContext(), YourScore.class));
    }
}
