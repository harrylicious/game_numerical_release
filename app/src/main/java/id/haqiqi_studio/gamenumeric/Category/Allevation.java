...
public class Allevation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allevation);
        ...
        new CountDownTimer(500000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (counter <= 30) {
                    ...
                    step2.setBackground(getResources().getDrawable(R.drawable.circle_btn_green));
                    ...
                    step3.setBackground(getResources().getDrawable(R.drawable.circle_btn_green));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
                    ...
                    step4.setBackground(getResources().getDrawable(R.drawable.circle_btn_green));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
                    ...
                    step5.setBackground(getResources().getDrawable(R.drawable.circle_btn_green));
                    delay = 5;
                    panel.setVisibility(View.VISIBLE);
                    jeda.setText(String.valueOf(delay--) + " detik");
                    container.removeAllViews();
    ...
    void addNewQuestion(int duration) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            newButton.setBackground(getResources().getDrawable(R.drawable.layer_btn_green));
